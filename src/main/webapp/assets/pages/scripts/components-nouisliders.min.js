...
jQuery(document).ready(function () {
    ...
    total_qz();
    totalBus();
    $("#up_title").attr("title","观音桥东环路--空港新城");
    $("#down_title").attr("title","空港新城--观音桥东环路");
});
...
function line_numchange(){
    $("#bus_line_num").change(function () {
        if($(this).val()=="619"){
            ...
            $("#up_title").attr("title","空港新城--红旗河沟枢纽站");
            $("#down_title").attr("title","红旗河沟枢纽站--空港新城");
...
function bus_depart_list(result,showSaveBtn,projectName){
    ...
    $.each(result,function (i, item) {
        ...
        var table="<div class=\"portlet box blue\">\n" +
            ...
            if(showSaveBtn){
                table+="<a class='btn btn-primary btn-sm' href='#' onclick='openNew("+item.lineNum+")'>"+$("#blrz-entry-date-start-xx").val()+"  "+item.lineNum+" 发车时间表(点击查看分析)&nbsp;&nbsp;&nbsp;车辆数："+carNum+"&nbsp;&nbsp;&nbsp;最优车辆数："+item.perfectTotal+"</a>" ;
            }else{
