...
public class CompressorUtil {
    ...
    public static void main(String[] args) {
        String yuiPath = "L:\\study\\js_pressor\\yuicompressor-2.4.7\\yuicompressor-2.4.7\\build\\yuicompressor-2.4.7.jar";
        String filePath = "I:\\STUDYSOURCE\\IdeaProjects\\cq_bus\\src\\main\\webapp\\assets\\global\\plugins\\datatables\\";
